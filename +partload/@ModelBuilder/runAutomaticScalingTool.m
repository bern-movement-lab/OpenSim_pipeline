...
EndErr=0.007; % End condition for RMS error of loop while
...
Scaler.getModelScaler.setMarkerFileName(TRCFile); % Loading the TRC file with exp markers to use to perform the scaling factors
